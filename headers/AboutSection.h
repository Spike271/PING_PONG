...
static const char* text[] = {
	...
	" - You can always change the default scoring thing by going in the 'options' section",
	"   and then change the value and save it!(web version doesn't have this feature)",
